...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className={cn(
        "h-12 w-12 rounded-xl border-2 border-border flex items-center justify-center transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.15)] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.15)] active:translate-y-[4px] active:shadow-none",
