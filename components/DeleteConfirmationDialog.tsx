    ...
    const modalContent = (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            <div className="relative bg-card border-2 border-border rounded-3xl shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] p-8 max-w-md w-full animate-in fade-in zoom-in-95 duration-200">
                ...
                <button
                    onClick={onClose}
                    className="absolute top-4 right-4 p-2 rounded-xl hover:bg-foreground hover:text-background border-2 border-transparent hover:border-border transition-all text-foreground"
                >
                ...
                {/* Title */}
                <h3 className="text-2xl font-black text-foreground text-center mb-2 uppercase tracking-tight">
                    {title}
                </h3>
