  ...
  if (status === 'success') {
    return (
      <div className="flex items-center gap-4 bg-card border-2 border-border p-4 rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] w-full max-w-sm">
        ...
        <div>
          <h4 className="font-black text-foreground uppercase text-lg leading-tight">Succès !</h4>
          <p className="font-bold text-muted-foreground text-xs uppercase">Contenu généré</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="flex items-center gap-4 bg-card border-2 border-border p-4 rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] w-full max-w-sm">
      ...
      <div className="flex-1 min-w-0">
        <h4 className="font-black text-foreground uppercase text-lg leading-tight">Génération...</h4>
        <div className="h-4 overflow-hidden relative">
          <div className="animate-slide-up-infinite">
            <p className="font-bold text-muted-foreground text-xs uppercase">Flashcards</p>
            <p className="font-bold text-muted-foreground text-xs uppercase">Quiz</p>
            <p className="font-bold text-muted-foreground text-xs uppercase">Résumés</p>
            <p className="font-bold text-muted-foreground text-xs uppercase">Notes</p>
            <p className="font-bold text-muted-foreground text-xs uppercase">Flashcards</p>
          </div>
        </div>
      </div>
