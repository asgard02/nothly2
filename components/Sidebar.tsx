          ...
          <div className="border-t-2 border-border p-4 bg-muted">
            <div className="flex flex-col gap-2">
              <button
                ...
                className={cn(
                  "flex items-center p-2 rounded-lg hover:bg-card hover:border-border border-2 border-transparent transition-all text-foreground",
              ...
              <button
                ...
                className={cn(
                  "flex items-center p-2 rounded-lg hover:bg-destructive/10 text-destructive hover:border-destructive border-2 border-transparent transition-all",
                  isOpen ? "justify-start gap-3" : "justify-center"
                )}
              >
