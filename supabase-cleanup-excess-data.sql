...
-- ========================================
-- 2. Identifier toutes les collections d'étude (study_collections)
-- ========================================
SELECT 
  'Toutes les collections d''étude' as type,
  sc.id,
  sc.title,
  sc.user_id,
  sc.collection_id,
...
SELECT 
  'Résumés actifs par utilisateur' as type,
  d.user_id,
...
-- ========================================
SELECT 
  'Collections en échec ou en traitement' as type,
  sc.id,
  sc.title,
  sc.user_id,
  sc.status,
...
/*
SELECT 
  'Résumé par utilisateur' as type,
  user_id,
